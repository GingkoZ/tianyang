<?php
namespace Custom\Service\UserImporter\Impl;

use Symfony\Component\Security\Core\Encoder\MessageDigestPasswordEncoder;
use Topxia\Service\Common\BaseService;
use Custom\Service\UserImporter\UserImporterService;
    ...
    public function importUsers($organizationId,array $users)
    {
        ...
        try{
            ...
            for($i=0;$i<count($users);$i++){
                ...
                $userInfo['setup'] = 1;
                $userInfo['tyjh_organizationId'] = $organizationId;
    ...
    public function importUpdateNickname($organizationId,array $users)
    {
        ...
        try{
            ...
            for($i=0;$i<count($users);$i++){
                ...
                $this->getUserService()->changeOrganizationId($member["id"],$organizationId);
